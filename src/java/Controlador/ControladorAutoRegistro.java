 ...
 */
public class ControladorAutoRegistro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            if(menu.equals("AutoRegistro")){
                ...
                request.getRequestDispatcher("Vista/Modules/Configuracion/ConfiguracionOtros/Autos/Componentes/Page/RegistrarAutos/RegistrarAutos.jsp").forward(request, response);
            }
    }
