<%-- 
    ...
    Created on : 18 jun. 2023, 23:22:02
...
<html>
    ...
    <body>
        ...
        <div id="myModal" class="modal">
            <center><h2>REGISTRAR AUTOS</h2></center>
    ...
    <div class="ContenerdorFormularioRegistro">
        <form class="FormularioRegistro" action="ControladorAutoRegistro?menu=AutoRegistro" method="POST">                        
            <div class="Grupos">
                ...
                <input type="text"  name="txtMatricula" maxlength="6" oninput="validarLongitud(this)" required>
            </div>
            <div class="Grupos">
                <label>Marca:</label>
            ...
            <div class="Grupos">
                ...
                <input type="text"  name="txtGeneracion" required>
            </div>
            <div class="Botones">
