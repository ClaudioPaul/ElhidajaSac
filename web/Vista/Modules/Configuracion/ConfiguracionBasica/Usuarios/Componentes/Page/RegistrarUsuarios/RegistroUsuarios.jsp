<%-- 
    ...
    Created on : 18 jun. 2023, 23:34:50
...
<html>
    ...
    <div class="ContenerdorFormularioRegistro">
        <form class="FormularioRegistro" action="ControladorUsuarioRegistro?menu=UsuarioRegistro" method="POST">                        
            ...
            <div class="Grupos">
                <label>Usuario:</label>
                <input type="text" value="" name="txtUsuario" required>
            </div>
            <div class="Grupos">
                <label>Clave:</label>
                <input type="text" value="" name="txtClave" required>
            </div>
            <div class="Botones">
